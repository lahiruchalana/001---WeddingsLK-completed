    ...
    useEffect(() =>{
        const getTotal = () =>{
            const total = users.reduce((prev, user1) => {
                return  user1.progress == '1' && user.name == user1.emp_name ? prev + 1 : prev + 0
            },0)
            setTotal(total)
        }
    ...
    return (
        ...
        <Container>
            ...
            <Content>
                ...
                <br></br>
                <br></br>
                <Text4>Your Completed Weddings</Text4>
                ...
                <Products>
                    {
                        users.map(user1 => {
                            return user1.progress == '1' && user1.emp_name == user.name ? <UserItemConfirmedCustomers key={user1._id} user={user1} />
                            : null
                        })
                    } 
                </Products>
